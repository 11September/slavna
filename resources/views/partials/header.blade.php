<header>
    <div class="container">
        ...
        <div class="information_part-mobile">
            <div class="top-part">
                <div class="social-block">
                    <a class="social-item" href="{{ Voyager::setting('facebook_link') }}"><i class="fo fab fa-facebook-f"></i></a>
                    <a class="social-item" href="{{ Voyager::setting('linked_link') }}"><i class="fo fab fa-linkedin"></i></a>
                    <a class="social-item" href="{{ Voyager::setting('twitter_link') }}"><i class="fo fab fa-twitter"></i></a>
                </div>
