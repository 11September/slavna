<section id="thumbnails-about" class="thumbnails">
            ...
            <div class="row">
                ...
                <div class="col-md-4 wrapper-thubnail-item ">
                    <div class="thubnails-item thubnails-item-info">
                        <h5 class="thubnails-item-info-heading">О НАС</h5>
                ...
                <div class="col-md-4 wrapper-thubnail-item">
                    ...
                    <div class="thubnails-item-wrapper-lines">
                        <a class="thubnails-item-line-link" href="#">Акции</a>
                    </div>
                </div>
                <div class="col-md-4 wrapper-thubnail-item">
                    <div class="thubnails-item">
                ...
                <div class="col-md-4 wrapper-thubnail-item">
                    ...
                    <div class="thubnails-item-wrapper-lines">
                        <a class="thubnails-item-line-link" href="#">Награды</a>
                    </div>
                </div>
            </div>
        </div>
